...
- Python 2.7
- Gluu oxd Server - [Installation docs](https://github.com/GluuFederation/oxd-python/archive/3.1.0.zip)

### Library

- *Install from Pip* - `pip install oxdpython`

- *Source from Github* -  Download the zip of the oxd Python Library from [here](https://github.com/GluuFederation/oxd-python/archive/3.1.0.zip) and unzip to your location of choice
...
```
    ...
    client_name = 
    authorization_redirect_uri = https://client.example.com/userinfo
